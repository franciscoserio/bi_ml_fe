          ...
          <div>
            ...
            <div className="predictions_page">
              <div className="center_steps">
                <Steps
                  onClick1={handleClickDatasource}
                  number="1"
                  description="Data source"
                  bar="1"
                  numberColor={
                    this.state.chosenDatasource === "Select" ? "red" : "green"
                  }
                  borderNumberColor={
                    this.state.chosenDatasource === "Select" ? "red" : "green"
                  }
                ...
                {this.state.predictionColumn === "Select" ? (
                  <Steps
                    onClick1={
                      this.state.chosenDatasource !== "Select"
                        ? handleClickQuerying
                        : handleClickNone
                    }
                    number="2"
                    ...
                    bar="1"
                    numberColor={
                      this.state.chosenDatasource !== "Select" ? "red" : "grey"
                    }
                    borderNumberColor={
                      this.state.chosenDatasource !== "Select" ? "red" : "grey"
                    }
                ...
                <Steps
                  ...
                  bar="1"
                  numberColor={
                    this.state.predictionColumn !== "Select" ? "red" : "grey"
                  }
                  borderNumberColor={
                    this.state.predictionColumn !== "Select" ? "red" : "grey"
                  }
                ...
                <Steps
                  onClick1={handleClickConfirmation}
                  number="4"
                  description="Confirmation"
                  bar="0"
                  numberColor="grey"
                  borderNumberColor="grey"
                  borderColorBar="grey"
                />
              </div>
              ...
              <div class="wrappers">
                ...
                <Querying
                  getSelectedPredictionColumn={handleClickPredictionColumn}
                  dataSourceId={this.state.chosenDatasource}
                />
